...
mlearn.ing is a near-live research terminal for mapping attention across Solana, Pump.fun and PumpSwap: narrative propagation, pool microstructure, paid boosts, wallet lineage, KOL impulses and adversarial signal quality.
...
The official Pump repository exposes programs, IDLs and SDKs, not a hosted REST endpoint that returns every launch. mlearn.ing therefore uses the canonical on-chain source:
...
src/index.css                   Responsive mlearn.ing design system
...
public/assets/mlearn.ing-manifold.png
